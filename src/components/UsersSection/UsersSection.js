            ...
            <div className={style.usersListSection}>
                {userStatusUpdatingProcessStatuses.READY ?
                    <>
                        ...
                        {
                            this.props.hasNextpageFlag &&
                            <button className={style.userButton} onClick={this.props.getUsersFromServer}>
                                Load more
                            </button>
                        }
                    </> : <Loading/>
